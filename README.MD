...
```mermaid
graph TD
    A[petstore-scraping<br>camada Bronze<br>dados brutos] --> B[petstore-etl<br>camadas Silver/Gold<br>dados tratados e carregados]
    B --> C[[petstore-bi<br>BI, dashboards e análises]]
```
